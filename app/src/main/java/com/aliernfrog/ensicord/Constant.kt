...
const val githubRepoURL = "https://github.com/aliernfrog/ensicord"
 ...
 */
const val defaultReleasesURL = "https://raw.githubusercontent.com/aliernfrog/ensicord/refs/heads/main/releases.json"
...
object SettingsConstant {
    val socials = listOf(
        ...
        Social(
            ...
            url = "https://aliernfrog.github.io/ensicord"
        )
    )
    ...
    val credits = listOf(
        CreditData(
            ...
            description = R.string.settings_about_credits_dev
        ),
        CreditData(
            name = "infini0083",
